...
import com.z_martin.mylibrary.common.adapterHelper.entity.MultiItemEntity;
...
public abstract class BaseMultiItemQuickAdapter<T extends MultiItemEntity, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public int getParentPositionInAll(int position) {
        ...
        if (isExpandable(multiItemEntity)) {
            IExpandable IExpandable = (com.z_martin.mylibrary.common.adapterHelper.entity.IExpandable) multiItemEntity;
            for (int i = position - 1; i >= 0; i--) {
                MultiItemEntity entity = data.get(i);
                if (isExpandable(entity) && IExpandable.getLevel() > ((com.z_martin.mylibrary.common.adapterHelper.entity.IExpandable) entity).getLevel()) {
                    return i;
                }
            }
        } else {
