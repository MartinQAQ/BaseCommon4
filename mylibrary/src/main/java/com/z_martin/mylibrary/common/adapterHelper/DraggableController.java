...
import com.z_martin.mylibrary.common.adapterHelper.listener.IDraggableListener;
import com.z_martin.mylibrary.common.adapterHelper.listener.OnItemDragListener;
import com.z_martin.mylibrary.common.adapterHelper.listener.OnItemSwipeListener;
...
public class DraggableController implements IDraggableListener {
    ...
    public void initView(BaseViewHolder holder) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != BaseQuickAdapter.LOADING_VIEW && viewType != BaseQuickAdapter.HEADER_VIEW
