...
import com.z_martin.mylibrary.config.DBConfig;
...
public class DBUtils {
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onOpen(SQLiteDatabase db) {
            ...
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, DBConfig.TABLE_DETAIL));
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, DBConfig.TABLE_HOME));
        }
