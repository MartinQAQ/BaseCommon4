...
public class StatusBarUtils {
    ...
    public static void setColor(Activity activity, int color) {
        setColorAndBarAlpha(activity, ResourcesUtils.getColor(color), DEFAULT_STATUS_BAR_ALPHA);
    }
    /**
     * 设置状态栏颜色
     *
     * @param activity 需要设置的 activity
     * @param color    状态栏颜色值
     * @param statusBarAlpha 透明度 0：不透明 -255:完全透明
     */
    public static void setColor(Activity activity, int color, int statusBarAlpha) {
        setColorAndBarAlpha(activity, ResourcesUtils.getColor(color), statusBarAlpha);
    }
    ...
    public static void setColorAndBarAlpha(Activity activity, @ColorInt int color, int statusBarAlpha) {
        // 代表 5.0 及以上
