package com.z_martin.mylibrary.widgets.statusLayout;
...
public class StatusLayoutManager {
     ...
     * 三种默认布局 ID
     */
    private static final int DEFAULT_LOADING_LAYOUT_ID = R.layout.view_loading;
    private static final int DEFAULT_EMPTY_LAYOUT_ID = R.layout.view_empty;
    private static final int DEFAULT_ERROR_LAYOUT_ID = R.layout.view_network_error;

    /**
     * 默认布局中可点击的 view ID
     */
    private static final int DEFAULT_EMPTY_CLICKED_ID = R.id.empty_tv;
    private static final int DEFAULT_ERROR_CLICKED_ID = R.id.error_msg;
    private static final int DEFAULT_EMPTY_CLICKED_LL = R.id.empty_ll;
    private static final int DEFAULT_ERROR_CLICKED_LL = R.id.error_ll;

    /** 默认颜色 */
    private static final int DEFAULT_CLICKED_TEXT_COLOR = R.color.text_gray;
    /** 默认界面背景颜色 */
    ...
    private void createLoadingLayout() {
        ...
        if (!TextUtils.isEmpty(loadingText)) {
            TextView loadingTextView = loadingLayout.findViewById(R.id.load_content);
    ...
    private void createEmptyLayout() {
        ...
        // 点击事件回调
        View view = emptyLayout.findViewById(DEFAULT_EMPTY_CLICKED_LL);
        ...
        if (!TextUtils.isEmpty(emptyText)) {
            TextView emptyTextView = emptyLayout.findViewById(R.id.empty_tv);
        ...
        // 设置默认空数据布局的图片
        if (emptyImgID > 0) {
            ImageView emptyImageView = emptyLayout.findViewById(R.id.empty_img);
    ...
    private void createErrorLayout() {
        ...
        View view = errorLayout.findViewById(DEFAULT_ERROR_CLICKED_LL);
        if (view != null && onStatusChildClickListener != null) {
            // 设置点击按钮点击时事件回调
            view.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        if (!TextUtils.isEmpty(errorText)) {
            TextView errorTextView = errorLayout.findViewById(R.id.error_msg);
        ...
        // 设置默认出错布局的图片
        if (errorImgID > 0) {
            ImageView errorImageView = errorLayout.findViewById(R.id.error_img);
     ...
     * 显示出错布局
     */
    public void showErrorLayout(String errorText) {
    ...
    public StatusLayoutManager setDefaultEmptyText(String emptyText) {
        this.emptyText = emptyText;
        return this;
    }
    
    public StatusLayoutManager setDefaultErrorText(String errorText) {
        this.errorText = errorText;
        return this;
    }
    
    public StatusLayoutManager setDefaultEmptyImage(int emptyImgID) {
     ...
     * @return
     */
    public StatusLayoutManager setEmptyView(@LayoutRes int emptyView) {
        this.emptyLayoutID = emptyView;
        return this;
    }
     ...
     * @return 状态布局 
     */
    public StatusLayoutManager setErrorView(@LayoutRes int errorLayoutResId) {
